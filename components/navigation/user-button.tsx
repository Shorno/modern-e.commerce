            ...
            <div className={""}>
                <DropdownMenu modal={false}>
                    ...
                    <DropdownMenuContent className={"w-64 p-6"} align={"end"}>
                                ...
                                <div onClick={(e) => e.stopPropagation()}
                                    ...
                                    <div className={"flex items-center"}>
                                        <div className={"relative flex mr-2"}>
                                            <Sun
                                                className={"px-1 group-hover:text-yellow-600 absolute group-hover:rotate-180 dark:scale-0 dark:rotate-90 transition-all duration-500 ease-in-out"}/>
                        ...
                        >
                            <LogOut className={"mr-2 px-1 group-hover:scale-90"}/> Sign Out
                        </DropdownMenuItem>
                    </DropdownMenuContent>
                </DropdownMenu>
            </div>
